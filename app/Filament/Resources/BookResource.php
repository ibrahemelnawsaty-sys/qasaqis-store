...
class BookResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            // بلا خيار 'all': مع ١٦٠٠+ كتابًا كان يحمّل الكتالوج كلّه في صفحة واحدة
            // (SELECT * بأعمدة ثقيلة + غلاف + حقل ترتيب حيّ لكل صفّ) = تعليق. Filament
            // يحفظ اختيار «لكل صفحة» في الجلسة، فإزالته تُسقِط أي جلسة عالقة عليه للافتراضيّ.
            // الإجراءات الجماعية تجلب المحدَّد بمفاتيحه من الاستعلام الأساس لا الصفحة المعروضة.
            ->paginated([25, 50, 100])
