        ...
        return $table
            ->columns([
                Tables\Columns\ImageColumn::make('cover_image')
                    ->label('الغلاف')
                    // مصغّر صغير (~110px) بدل الأصل (1000×1500): بايتات وفكّ ترميز أخفّ
                    // بكثير حين تُصفّ عشرات الأغلفة. adminThumbUrl يعيد رابطًا كاملًا فيقبله
                    // ImageColumn مباشرةً (يولَّد عند أوّل طلب ثم static، صامد لأصلٍ إن تعذّر).
                    ->getStateUsing(fn (Book $record): ?string => $record->adminThumbUrl())
                    ->square(),
            ...
            // يصيّر كلّ الصفوف بحقول ترتيب حيّة دفعةً واحدة. للسرعة القصوى ٢٥–١٠٠/صفحة.
