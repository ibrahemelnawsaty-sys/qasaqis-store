...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        // جاهزيّة Cloudflare: نثق بنطاقات Cloudflare المعلَنة كوسطاء، فيُقرأ عنوان
        // الزائر الحقيقيّ من X-Forwarded-For بدل عنوان Cloudflare — وإلّا لَبَدت كل
        // الزيارات خلف حفنة عناوين مشتركة فأخطأ التقييد (throttle) وكشفُ العنوان.
        // خامل قبل الربط: طلبات العناوين الحقيقيّة ليست ضمن النطاقات فلا تُوثَق ترويساتها.
        // المصدر: https://www.cloudflare.com/ips/ (يُحدَّث نادرًا).
