...
@push('head')
    ...
    <style>
        ...
        /* حرِج: يمنع تمدّد مسار الشبكة إلى محتوى عريض. مبدّل السلسلة (.series-switch__row فيه
           عشرات العناصر بتمرير أفقيّ) كان يفجّر عرض العمود على الجوال (grid track = min-content)
           فتصير الصورة عملاقة خارج الشاشة ويظهر تمرير أفقيّ فارغ. min-width:0 يجعل العمود يتقلّص
           فيتمرّر المبدّل داخليًّا بدل تفجير الصفحة. لا يؤثّر على سطح المكتب (مسار الوسائط
           محدّد بـminmax(300px،.9fr) فلا ينكمش دونها). */
        .wrap .pdp > *{ min-width:0; }
...
@section('content')
    <div class="wrap" style="padding-block:clamp(20px,4vw,34px)">
        ...
        <section class="sec" aria-labelledby="pdp-reviews">
            ...
            {{-- نموذج إضافة رأي: للعميلة المسجّلة يظهر النموذج، وللزائرة دعوةٌ لتسجيل
                 الدخول. الجزئية محروسة ذاتيًا (وجود المسار + حارس customer) فآمنة
                 الإدراج دائمًا. كان غيابها سبب تعذّر إضافة الآراء رغم اكتمال المنطق. --}}
