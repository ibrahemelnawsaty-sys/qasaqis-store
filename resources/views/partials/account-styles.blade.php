...
@once
    <style>
        ...
        .acc-addr{ display:flex; flex-direction:column; gap:10px;
            border:1px solid var(--line); border-radius:var(--r-md); padding:12px 14px; margin-bottom:10px; }
        .acc-addr .acc-addr-row{ display:flex; gap:12px; align-items:flex-start;
        ...
        /* إعادة التسمية: تفصيلة أصلية بلا JS (تعمل على شبكة ضعيفة) */
        .acc-addr-rename{ border-top:1px dashed var(--line); padding-top:10px; }
        .acc-addr-rename > summary{ cursor:pointer; font-size:12.5px; color:var(--purple);
            min-height:32px; display:inline-flex; align-items:center; gap:6px; list-style:none; }
        .acc-addr-rename > summary::-webkit-details-marker{ display:none; }
        .acc-addr-rename-form{ display:flex; gap:8px; flex-wrap:wrap; align-items:flex-start; margin-top:8px; }
        .acc-addr-rename-form .co-input{ flex:1; min-width:180px; }
