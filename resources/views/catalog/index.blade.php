...
{{-- <title> يُحسب في @php أدناه (يحترم تجاوز الأدمن meta_title ويطابق معاينة SeoDefaults)
     ثم يُضبط بعده — كان ثابتًا هنا فيُهمَل meta_title المُدخَل للقسم/السلسلة. --}}
